...
\begin{abstract}
    ...
    implementation in realistic synthetic experiments. Our method also relies on several novel properties that we prove about the Bessel distribution.~\looseness=-1
  \end{abstract}
